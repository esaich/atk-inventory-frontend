// src/pages/Admin/Pengadaan/PengadaanCreateModal.jsx
...
export default function PengadaanCreateModal({ isOpen, onClose, onSuccess, showAlert }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await pengadaanAPI.createBulk([formData]);
      onSuccess('Pengadaan berhasil diajukan!');
      resetForm();
      onClose();
    } catch (error) {
      console.error('Error creating pengadaan:', error);
      showAlert('error', `Gagal mengajukan pengadaan: ${error.message}`);
    } finally {
      setSubmitting(false);
    }
  };
      ...
      footer={
        <>
          ...
          <Button
            ...
            label={submitting ? 'Menyimpan...' : 'Ajukan'}
            variant="primary"
